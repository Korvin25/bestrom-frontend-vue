  ...
  <main class="main-content flex-column">
      ...
      <div class="catalog-select-card card-shadow flex-column">
        ...
        >
          <app-catalog-type-select
            v-for="filters in FILTERS.find((e) => e.name === radioCatalogSelect)
              .Filters"
            :key="filters.id"
    ...
    <section class="mobile-section section">
      <div
        ...
        class="mobile-filter card-shadow flex-column"
      >
      ...
      <transition-group name="mobile-filter-modal">
        <section
          ...
          class="mobile-nav-elements flex-column"
        >
          <img
          ...
          <div class="flex-column">
              ...
              >
                <slide v-for="category in FILTERS" :key="category.id">
                  <p
                    ...
                    :class="
                      radioCatalogSelect === category.name ? 'choice' : ''
                    "
                  >
                    {{ category.name }}
                  </p>
            ...
            >
              <app-catalog-type-select
                v-for="filters in FILTERS.find(
                  (e) => e.name === radioCatalogSelect
                ).Filters"
                :key="filters.id"
                :class="
                  typeSelect === filters.name ? 'type-select-checked' : ''
                "
                @click="typeSelectFunc(filters.name, filters.search)"
                :text="filters.name"
              ></app-catalog-type-select>
