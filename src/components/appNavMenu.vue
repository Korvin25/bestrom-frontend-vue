  ...
  <nav class="nav flex-row">
    ...
    <div class="nav-logo-items flex-column">
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 2 || this.$route.path.includes('/about')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 3 || this.$route.path.includes('/catalog')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 4 || this.$route.path.includes('/cutting')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 6 || this.$route.path.includes('/news')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 7 || this.$route.path.includes('/partners')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 8 || this.$route.path.includes('/clients')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <router-link
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 10 || this.$route.path.includes('/jobs')
            ? 'img-hover'
            : ''
        "
        @click="scrollToTop"
      ...
      <a
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 11 || showModalMenuApplication ? 'logo-hover' : ''
        "
    ...
    <div class="nav-text-items flex-column">
      ...
      <a
        ...
        @mouseleave="hoverItem = 0"
        :class="
          hoverItem === 11 || showModalMenuApplication ? 'text-hover' : ''
        "
        @click="showModalMenuApplication = true"
        class="nav-item text"
      >
      ...
      <nav v-if="this.showMobileMenu" class="mobile-nav-elements flex-column">
        ...
        <div class="mobile-menu-nav-items flex-column">
          ...
          >
            <div
              :class="
                hoverItem === 1 || this.$route.path === '/' ? 'img-hover' : ''
              "
            ...
            <p
              :class="
                hoverItem === 1 || this.$route.path === '/' ? 'text-hover' : ''
              "
            >
              Главная
            </p>
          ...
          <a
            @click="showModalMenuServiceClick"
            class="nav-mobile-item flex-row"
          >
            <div
              :class="hoverItem === 5 ? 'img-hover' : ''"
          ...
          <div class="mobile-menu-nav-bottom flex-row">
            ...
            >
              <img
                src="../assets/menu-mobile-call.png"
                alt="menu-mobile-call"
              />
              <p>Заявка</p>
            </div>
            <div
            ...
            >
              <img
                src="../assets/menu-mobile-message.png"
                alt="menu-mobile-message"
              />
              <p>Написать</p>
            </div>
            <div
            ...
            >
              <img
                src="../assets/menu-mobile-contacts.png"
                alt="menu-mobile-contacts"
              />
              <p>Контакты</p>
            </div>
          </div>
