<template>
  <div
    class="desktop-section catalog-item-product flex-row card-shadow"
    v-if="searchBoolean"
  >
  ...
  <div
    class="mobile-section catalog-item-product flex-row card-shadow"
    v-if="searchBoolean"
  >
    <div class="about-content flex-column">
      <h3>{{ title }}</h3>
      ...
      <section class="section">
        ...
        >
          <slide
            v-for="slide in PRODUCT_ID.ProductPropertyValue"
            :key="slide.id"
          >
