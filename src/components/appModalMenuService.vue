    ...
    <div class="modal-window card-shadow flex-column">
      ...
      <div class="service-buttons flex-row">
        <button
          ...
          :class="!switchContent ? 'btn-disabled' : 'btn'"
        >
          ВЫЗОВ СПЕЦИАЛИСТА
        </button>
        <button
      ...
      <form v-if="!switchContent" class="form-call flex-column" action="">
        ...
        <transition-group name="modal">
          <div
            v-for="input in this.inputsDetails"
            :key="input.id"
            class="flex-row call-inputs"
          >
        ...
        <transition-group name="modal">
          <div
            v-for="input in this.inputsFile"
            :key="input.id"
            class="flex-row call-inputs"
          >
            <input type="text" class="input" :value="input.content" readonly />
            <div @click="removeInputFile(input.id)" class="del-btn">
              Удалить
            </div>
          </div>
        </transition-group>
